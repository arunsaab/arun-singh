...
const Skill = () => {
  return (
    <div className="container mx-auto " id="skills">
      <h2 className="mb-12 mt-20 text-center text-center text-4xl font-semibold">
        Skills
      </h2>
      <motion.div
        initial="hidden"
        ...
        // Removing 'once: true' so it animates every time it comes into view
        viewport={{ amount: 0.2 }} // Trigger animation when at least 20% of the container is in the viewport
